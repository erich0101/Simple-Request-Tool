...
export const AIGenerateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const CopyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path fillRule="evenodd" d="M10.5 3.75a2.25 2.25 0 00-2.25 2.25v10.5a2.25 2.25 0 002.25 2.25h6a2.25 2.25 0 002.25-2.25V6a2.25 2.25 0 00-2.25-2.25h-6zM9 6a.75.75 0 01.75-.75h6a.75.75 0 01.75.75v10.5a.75.75 0 01-.75.75h-6a.75.75 0 01-.75-.75V6z" clipRule="evenodd" />
      <path d="M6.75 3a.75.75 0 00-.75.75v10.5a.75.75 0 00.75.75h.75v-1.5a2.25 2.25 0 012.25-2.25h3.75a.75.75 0 000-1.5H9.75a3.75 3.75 0 00-3.75 3.75v1.5H6a2.25 2.25 0 01-2.25-2.25V3.75A2.25 2.25 0 016 1.5h6a2.25 2.25 0 012.25 2.25v.75a.75.75 0 001.5 0V3.75a3.75 3.75 0 00-3.75-3.75h-6A3.75 3.75 0 004.5 3.75v10.5A2.25 2.25 0 016.75 12h.75a.75.75 0 000-1.5H6.75a.75.75 0 00-.75.75z" />
    </svg>
);
...
export const VerticalLayoutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v16.5h16.5V3.75H3.75zM12 3.75v16.5" />
    </svg>
);

export const HorizontalLayoutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const PrintIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6 18.25M3.75 12h16.5m-16.5 0a9 9 0 0116.5 0M12 8.25v1.5m0 3v1.5m0 3v1.5m0 3V18m-3-12V6.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V8.25m-7.5 0h7.5m-7.5 0c-.621 0-1.125.504-1.125 1.125v3.75c0 .621.504 1.125 1.125 1.125h7.5c.621 0 1.125-.504 1.125-1.125v-3.75c0-.621-.504-1.125-1.125-1.125h-7.5z" />
  </svg>
);
...
export const LinkedInIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    ...
    {...props}
  >
    <rect width="24" height="24" fill="#0A66C2" rx="3" ry="3" />
    <path
      fill="#FFFFFF"
      d="M19 19H16V13.38C16 11.93 15.48 11.02 14.31 11.02C13.02 11.02 12.5 11.88 12.5 13.38V19H9.5V9H12.5V10.3H12.55C12.96 9.54 13.81 9 15.09 9C17.29 9 19 10.34 19 13.03V19ZM5 19H8V9H5V19ZM6.5 7.5C5.4 7.5 4.5 6.6 4.5 5.5C4.5 4.4 5.4 3.5 6.5 3.5C7.6 3.5 8.5 4.4 8.5 5.5C8.5 6.6 7.6 7.5 6.5 7.5Z"
    />
  </svg>
);
